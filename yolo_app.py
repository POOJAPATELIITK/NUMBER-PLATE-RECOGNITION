...
# Load YOLO model
try:
    model = YOLO(r'C:\Users\DELL\Downloads\YOLO\best.pt')  # Replace with your trained YOLO model
...
if uploaded_file is not None:
    # Ensure "temp" is a valid directory
    if not os.path.exists("temp"):
        os.makedirs("temp")
    elif not os.path.isdir("temp"):
        st.error("'temp' exists as a file. Please delete/rename it so a folder can be created.")
